...
* [x] Compact Gain card fade buttons fixed (v1.3.14): removed Expanded widget from FadeButton to properly stack buttons vertically with full width.
* [x] ALO Regular card sizing fixed (v1.3.14): ALO Regular card now matches Gain Regular card width (regularWidth, 240px height).
